...
if (isset($_POST['actionType'])) {
  switch ($_POST['actionType']) {
    case "Add":
      if (insertPlayerTeam($_POST['tid'], $_POST['pid'], $_POST['ptSalary'], $_POST['ptYearsPlayed'])) {
      ...
      break;
    case "Edit":
      if (updatePlayerTeam($_POST['tid'], $_POST['pid'], $_POST['pSalary'], $_POST['pYears'], $_POST['ptid'])) {
