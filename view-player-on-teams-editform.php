...
<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#editPlayerOnTeamsModal<?php echo $team['Team_ID']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editPlayerOnTeamsModal<?php echo $team['Team_ID']; ?>" tabindex="-1" aria-labelledby="editPlayerOnTeamModalLabel<?php echo $team['Team_ID']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editPlayerOnTeamModalLabel<?php echo $team['Team_ID']; ?>">Edit Player On Team</h1>
